...
const ADDITIONAL_INSTRUCTIONS = [
  ...
  "",
  "EVERY SLIDE MUST INCLUDE (as visible text elements on the slide itself):",
  "- Slide number (e.g., '1/60', '2/60', etc.) in the bottom-left corner",
  "- 'www.impactmojo.in' in the bottom-center",
  "- 'CC BY-NC-SA 4.0' license badge in the bottom-right corner",
  "These three elements must appear on EVERY single slide including the first and last. Make them small but visible.",
  "",
