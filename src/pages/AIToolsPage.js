...
import { Bot, ExternalLink, Star, ArrowRight, BarChart, Target, FileText, Users, CheckCircle, MessageCircle, Calendar, BookOpen, TrendingUp, Scale, Award, Trophy, Puzzle, Zap } from 'lucide-react';
                  ...
                  <div className="flex items-center">
                    <div className={`flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-md bg-${selectedTool.color}-100 dark:bg-${selectedTool.color}-900`}>
                      {(() => {
                        ...
                        return <ModalIcon className={`h-8 w-8 text-${selectedTool.color}-600 dark:text-${selectedTool.color}-400`} />;
                      })()}
                    </div>
