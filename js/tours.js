...
(function () {
  ...
  var TOURS = {
    index: [
      { intro: '<strong>Welcome to ImpactMojo!</strong><br>Development know-how for South Asia — 80 courses, 135 games and 35 studios, all free, built by practitioners. Here’s a quick lay of the land.' },
      { element: '#nav-learn', intro: '<strong>Learn</strong><br>The heart of the platform: 80 courses (21 flagship + 59 foundational), interactive studios, and practice packs.' },
      ...
      { element: '#nav-specials', intro: '<strong>Explore</strong><br>The 135-game library, 172 reading companions, 25 deep dives, citation-backed timelines, and daily practice dojos.' },
