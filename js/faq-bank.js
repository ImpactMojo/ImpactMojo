(function(){
  ...
  const FAQ = [
    ...
    { re: /\bpremium\b(?!.*(what|include|benefit|price))/i,
      a: "Premium offers two tiers. **Practitioner** includes Field Notes from a Development Economist, RQ Builder Pro, certificates, and community access. **Professional** adds Qualitative Research Lab, Statistical Analysis Assistant, VaniScribe AI Transcription (10+ South Asian languages), DevData Practice (36 generators, 840k+ rows), Visualization Cookbook (14 chart types), and the DevEconomics Toolkit (11 Shiny apps). Visit the Premium page for details." },
    { re: /\b(what('| i)?s|about).+premium|\bpremium\b.+(include|cover|benefit)/i,
      a: "**Practitioner Tier** includes Field Notes, RQ Builder Pro, completion certificates, and community access. **Professional Tier** adds Qual Research Lab, Stats Assistant, VaniScribe AI Transcription, DevData Practice datasets, Visualization Cookbook, and the DevEconomics Toolkit with 11 interactive Shiny apps. See the Premium page for current pricing." },
