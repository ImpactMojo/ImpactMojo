...
(function () {
  ...
  function renderLockedModule(placeholder, mod) {
    placeholder.innerHTML =
      ...
      '<h3 style="font-family:var(--font-display,Poppins,sans-serif);margin-bottom:0.5rem;color:var(--text-primary,#1e293b);">Sign in to continue</h3>' +
      ...
      '<a href="/#auth" style="display:inline-flex;align-items:center;gap:0.5rem;padding:0.75rem 1.5rem;background:var(--color-primary,#4F46E5);color:#fff;border-radius:8px;font-weight:600;text-decoration:none;transition:transform 0.2s;">Sign up free &rarr;</a>' +
      '</div>';
  }
