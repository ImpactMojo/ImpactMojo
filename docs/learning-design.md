...
3. **Free and open.** All 21 flagship courses, 57 foundational courses, 135 games, 35 labs, and 90 handouts are free. No paywall on learning.
...
The 57 foundational courses are shorter and more focused. They cover a single topic in depth — think of them as reference guides you can read in one sitting or assign as pre-reading before a workshop.
...
| Method | Purpose | Where It Appears |
|--------|---------|------------------|
| **Quizzes** | Quick self-checks to reinforce key concepts | End of each module |
| **Reflection prompts** | Connect ideas to your own context and practice | Throughout modules |
| **Lab outputs** | Produce real, usable deliverables (ToC frameworks, research designs, survey instruments) | Interactive Labs |
| **Portfolio building** | Collect your outputs over time into a body of work | Across courses and labs |
...
1. **Play.** Experience the dilemma firsthand. Make choices, see consequences.
2. **Debrief.** Discuss what happened and why. This is where the real learning occurs — connecting the game experience to theory.
3. **Apply.** Link the game's lesson to real-world development scenarios. ("Where in your work do you see a public goods problem?")
...
The 35 interactive labs are guided, step-by-step workflows that produce a real output at the end. Think of them as digital workbenches.
...
1. Define your program's long-term goal.
2. Identify outcomes at each level (impact, outcome, output).
3. Map assumptions and evidence for each causal link.
...
ImpactMojo has over 90 handouts. These are single-page reference materials designed for three uses:

1. **Workshop facilitation.** Print them for participants. They summarize key frameworks, checklists, and definitions on one page.
2. **Self-study.** Use them as quick-reference guides alongside a course.
3. **Team training.** Share them with colleagues who need a concept explained concisely.
