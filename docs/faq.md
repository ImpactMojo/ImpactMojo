...
Yes. All 21 flagship courses (13 modules each), 57 foundational courses, 135 learning games, 35 interactive studios, 90 handouts, the ImpactLex glossary (390+ terms), 200 Dev Case Studies, 500+ DevDiscourses papers, and interactive BookSummaries are completely free.
...
1. Visit the ImpactMojo site on your phone or laptop browser.
2. Your browser will prompt you to "install" or "add to home screen."
3. Once installed, flagship course content is cached on your device.
4. You can read courses, review handouts, and study even without an internet connection.
...
1. Open the handout you want to print.
2. Press **Ctrl+P** (Windows/Linux) or **Cmd+P** (Mac).
3. In the print dialog, choose your printer or select "Save as PDF" to create a digital copy.
4. Print.
...
1. **GitHub Issues.** If you are comfortable with GitHub, open an issue on the ImpactMojo repository. This is the fastest way to report a bug, suggest a correction, or request new content.
2. **Email.** Send your suggestion or error report to the ImpactMojo team by email. You will find the contact address on the site.
...
|---------|----------------|------------------------|------------------------|-------------------------------|
| All 78 courses | Yes | Yes | Yes | Yes |
...
**Flagship courses** (18 in total) are ImpactMojo's most developed learning experiences. Each one has:
...
Look for the chat widget on platform pages. For more details, see the [Mojini Guide](mojini-guide.md).
...
For full bios, see [Who We Are](team.md).
...
For full details, see [Certificates and Progress](certificates-and-progress.md).
...
|--------|---------------|------|
| **AI Policy** | How we use (and don't use) AI | [Read](ai-policy-guide.md) |
| **Terms of Service** | Rules for using the platform | [Read](terms-guide.md) |
| **Privacy Policy** | What data we collect and how we use it | [Read](privacy-guide.md) |
| **Refund Policy** | Cancellation and refund terms for paid services | [Read](refund-guide.md) |
| **Data Protection** | DPDPA compliance and your data rights | [Read](data-protection-guide.md) |
...
|---------|-----------------|
| Course content | Annually, or when evidence/best practices change |
| Platform features | Continuous; major releases announced via blog and newsletter |
| AI policy | Quarterly |
| Legal pages | Annually, or when regulations change |
| Dataverse resources | New additions monthly; existing entries reviewed quarterly |
| Documentation | Updated alongside platform changes |

All updates are logged in the [Changelog](changelog.md).
