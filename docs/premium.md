...
ImpactMojo's core belief is that high-quality development education should be free. All 76 courses, 135 games, 35 labs, 90 handouts, and the entire Dataverse are free to use — no login required, no paywall, no trial period.
...
- **All courses** — 21 flagship + 55 foundational courses across 6 learning tracks
...
- **Dataverse** — 334 data tools, APIs, and datasets
...
- **56 sessions** across six skill series: Thinking Clearly, Evidence Reasoning, Political Economy & Implementation, Methods That Actually Work, Epistemic Hygiene, and Gender, Power & Data
- **Structured series** available (6–16 sessions per series for deep skill building)
