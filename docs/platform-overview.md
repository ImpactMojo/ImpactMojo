...
Comprehensive study decks that cover a specific skill or concept in depth. These are self-paced reading materials — thorough in their coverage but simpler in format than flagship courses. **All 56 foundational courses are native ~100-slide HTML decks** with interactive charts, light/dark theme, and keyboard/touch navigation — fully self-hosted, with no third-party presentation embeds. See the [101 Course Decks Guide](101-decks-guide.md) for details.
...
- `list_courses` — 77 courses across 6 learning tracks
...
The vast majority of ImpactMojo is **completely free** — this is a genuine commitment, not a marketing strategy. All 77 courses, 135 games, 35 studios, handouts, ImpactLex, case studies, DevDiscourses, and Dataverse are available at no cost.
