...
Comprehensive study decks that cover a specific skill or concept in depth. These are self-paced reading materials — thorough in their coverage but simpler in format than flagship courses. **All 52 foundational courses are native ~100-slide HTML decks** with interactive charts, light/dark theme, and keyboard/touch navigation — fully self-hosted, with no third-party presentation embeds. See the [101 Course Decks Guide](101-decks-guide.md) for details.
...
- **334 datasets, tools, and APIs** from sources like the World Bank, DHS, NFHS, NSSO, and more
...
Interactive reading companions that go far beyond a summary. Each BookSummary offers chapter-by-chapter navigation, evidence explorers, data playgrounds with interactive simulators, programme comparison tools, concept glossaries, and AI-powered Q&A. Currently available under Specials. See the [Reading Companions Guide](book-summaries-guide.md) for full details.

**Current entries: 166 reading companions** spanning development economics (Poor Economics, Why Nations Fail, Development as Freedom, Debraj Ray), econometrics and statistics (Gujarati, Naked Statistics, Learning Statistics with R), data visualization (Tufte, Storytelling with Data, The Truthful Art), research methods, communication, leadership, and productivity. See the full list in the [Content Catalog](content-catalog.md).
...
- `browse_dataverse` / `search_dataverse` — 334 tools, datasets, APIs
- `list_challenges` / `get_challenge` — Practice exercises with rubrics
- `list_courses` — 73 courses across 6 learning tracks
...
The vast majority of ImpactMojo is **completely free** — this is a genuine commitment, not a marketing strategy. All 73 courses, 135 games, 35 studios, handouts, ImpactLex, case studies, DevDiscourses, and Dataverse are available at no cost.
