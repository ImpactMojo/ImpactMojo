...
ImpactMojo's **58 foundational courses** are slide decks you read in a browser. Each is a single self-hosted HTML page of roughly 100 slides, with a light/dark/system theme, keyboard and touch navigation, fullscreen, and interactive Chart.js figures where the argument needs a chart rather than a sentence.
