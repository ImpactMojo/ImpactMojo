...
Processing time depends on audio length and quality, but a 60-minute recording typically takes a few minutes to process — compared to 4–6 hours of manual transcription.

**Is my audio data secure?**
Audio files are processed and not stored permanently. See ImpactMojo's [data protection policy](https://www.impactmojo.in/data-protection.html) for details.

**Can I transcribe phone call recordings?**
Yes, as long as you have the audio file and appropriate consent from participants.

**What if my recording has multiple languages?**
VaniScribe handles code-switching (e.g., Hindi-English) reasonably well. Select the dominant language when uploading.
