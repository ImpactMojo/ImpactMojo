...
Look at issue #$ARGUMENTS in the Varnasr/ImpactMojo repo.

!`curl -s -H "Authorization: token $GITHUB_PAT" https://api.github.com/repos/Varnasr/ImpactMojo/issues/$ARGUMENTS`
