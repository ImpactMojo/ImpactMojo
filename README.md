...
|----------|-------------|
| **79 Courses** | 21 flagship + 58 foundational courses across 6 learning tracks (all foundational decks self-hosted as native HTML slide decks). Every flagship ends with an auto-graded "Assess Yourself" self-check |
...
| **Dataverse** | 334 curated tools, datasets, APIs, MCP servers, and platforms across 22 categories — dark mode, category filters, responsive cards |
...
| **24 Deep Dives** | Curated, annotated reading guides — working syllabi on contested development questions |
...
| Track | Courses |
|-------|---------|
| **MEL, Research & Data Methods** (18) | MEL Basics, Theory of Change, Logframe, Impact Evaluation, Cost Effectiveness, Survey Design, Systematic Reviews & Evidence Synthesis, Academic Writing & Publishing, Structural Equation Modelling, Qualitative Analysis Software, Qualitative Methods, Mixed Methods, Research Ethics, Observation to Insight, Exploratory Data Analysis, Bivariate Analysis, Multivariate Analysis, Item Response Theory |
...
| **Communication, Data & Digital** (11) | English for Development, Visual Ethnography, Data Literacy, Statistics Without Code, Data Visualization, Behaviour Change Communication, Advocacy Basics, Education and Pedagogy, Digital Ethics, GenAI for Practitioners, Data Protection & the DPDP Act |
...
- **[LMS export](https://www.impactmojo.in/lms-export)** (`lms-export.html`) — package any of the 79 courses — plus the 47 practice workbooks — as **SCORM 1.2**, **SCORM 2004**, **IMS Common Cartridge 1.3**, or a single self-contained HTML file. The package is built in your browser from the live page, so it is never stale. Our analytics, sign-in, Supabase and translation code are stripped before packaging and the rest inlined, so an imported course runs with no network and phones nothing home. SCORM reports completion when the learner reaches the final slide.
...
- **Dataverse** — 334 curated tools, datasets, APIs, MCP servers, and platforms for social impact research
...
├── dataverse.html          # Dataverse (334 tools & datasets across 22 categories)
